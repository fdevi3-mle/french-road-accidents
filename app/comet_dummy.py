...
from app.main import generate_random_classifier_request
...
def do_stuff(filepath=ZENML_FILE_PATH):
    ...
    runpy.run_path(
        ZENML_FILE_PATH)  # api = API(api_key="Xh1kXXM0IIPgqwAP3wTyChS0R")  # api.download_registry_model("fdevi3", "forecast-arima-model", output_path="./", expand=True)
