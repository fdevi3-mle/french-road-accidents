...
@st.cache_data
def data_loader(filepath=INPUT_PARQUET, sample_size=0.1): # size is low due to memory issues
    if filepath is None:
    ...
    if sample_size >0.1:
        sample_size = 0.1 ## just a block as streamlit cant handle large data
